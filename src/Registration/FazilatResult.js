...
function FazilatResult({ id, i, mname, sroll, reg, name, fname, mcode, dateBirth, total, divi }) {
    ...
    const nameClass = "text-3xl text-green-900 font-bold ml-20 mt-10";
    return (
        <div className="w-[90%] h-[80%] justify-center ml-24 mt-20 bg-gray-100">
            ...
            <div className="flex w-[80%] h-[80%] border border-green-800 ml-40 mt-20">
                <div className="flex flex-col w-[90%] h-[80%] mt-10 bg-gray-100 ml-10 ">
                ...
                <div className="w-[10%] h-[80%] mt-20 bg-gray-100 ml-34 mr-2 justify-right">
                    <button className='w-full rounded bg-blue-500 p-3 text-xl mt-96 mb-5 mr-3'
